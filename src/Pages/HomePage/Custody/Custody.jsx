...
const Custody = () => {
    return (
        <div className="container py-10">
            <div className="flex flex-col gap-10 md:flex-row-reverse justify-center items-stretch">

                <div className="w-full md:w-1/2 p-5">
                    <h2 className="font-bold text-2xl md:text-5xl pb-5">Self-custody is your right. You got more.</h2>
                ...
                <div className="w-full md:w-1/2 bg-[#ffffff10] flex flex-col md:flex-row justify-between md:items-end md:px-10 md:py-8 p-5 relative rounded-lg overflow-hidden">
                    ...
                    <div className="w-full md:p-0 p-3 flex justify-end md:w-1/3">
            ...
            <div className="w-full mt-6 bg-[#ffffff10] flex flex-col md:flex-row justify-between md:items-end md:px-10 md:py-8 p-5 relative gap-4 rounded-lg overflow-hidden">
